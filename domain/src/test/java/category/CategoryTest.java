...
class CategoryTest {
    ...
    @Test
    void givenAValidActiveCategory_whenCallDeactivate_theReturnCategoryInactivated() {
        final var expectedName = "Filmes";
        final var expectedDescription = "A categoria mais assistida";
        final var expectedIsActive = false;
    ...
    @Test
    void givenAValidInactiveCategory_whenCallActivate_theReturnCategoryActivated() {
        final var expectedName = "Filmes";
        final var expectedDescription = "A categoria mais assistida";
        final var expectedIsActive = true;
